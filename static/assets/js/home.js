...
// Splash texts
const SplashT = [
  "Forked by Interstellar, Optimized for users.",
  "Fastest proxy server from Interstellar",
  "Kudos to xBubbo for the Interstellar Network.",
  "Check out discord.gg/interstellar if you need support",
